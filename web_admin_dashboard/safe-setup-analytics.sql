-- Safe setup script for analytics tracking
-- This script checks for table existence and handles errors gracefully
...
DELETE FROM user_events WHERE event_type LIKE 'test_%';
DELETE FROM user_sessions WHERE session_id LIKE 'session_%';

-- 6. Add sample event data (with better error handling)
