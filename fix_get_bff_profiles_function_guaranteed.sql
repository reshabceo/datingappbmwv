-- FINAL GUARANTEED FIX: Create get_bff_profiles function with ONLY columns that definitely exist
-- Based on the working get_profiles_with_super_likes function

-- 1. Drop the existing function
DROP FUNCTION IF EXISTS public.get_bff_profiles(UUID);

-- 2. Create the function using ONLY columns from the working function
...
DO $$
BEGIN
  RAISE NOTICE '=== get_bff_profiles Function Fixed (GUARANTEED) ===';
  RAISE NOTICE 'Using ONLY columns from working get_profiles_with_super_likes function';
