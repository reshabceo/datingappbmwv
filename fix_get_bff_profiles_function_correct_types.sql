-- FIX: Create get_bff_profiles function with correct data types
-- Based on the actual table structure - some columns are JSONB, not TEXT[]

-- 1. Drop the existing function
DROP FUNCTION IF EXISTS public.get_bff_profiles(UUID);

-- 2. Create the function with the correct data types
...
DO $$
BEGIN
  RAISE NOTICE '=== get_bff_profiles Function Fixed (CORRECT TYPES) ===';
  RAISE NOTICE 'Using correct data types: JSONB for arrays, TEXT for strings';
